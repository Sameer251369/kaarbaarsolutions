  ...
  return (
    ...
    <div className="relative min-h-screen bg-black text-white flex justify-center items-start overflow-x-hidden pt-32 pb-20 px-6">
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-10">
        ...
        >
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-4 group mb-12">
               <div className="w-12 h-12 rounded-2xl overflow-hidden border border-white/10 group-hover:border-emerald-500/50 transition-all">
            ...
            <h2 className="text-7xl font-black tracking-tighter leading-[0.85]">
              Welcome back to <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400 italic">
                The Lab.
              </span>
            </h2>
          ...
          <div className="space-y-4 max-w-xs">
             {[
              ...
              <div key={i} className="flex flex-col gap-1 p-4 bg-white/[0.03] border border-white/5 rounded-2xl backdrop-blur-md">
        ...
        >
          <div className="bg-white/[0.03] backdrop-blur-3xl border border-white/10 p-8 lg:p-12 rounded-[3.5rem] shadow-2xl">
            <div className="mb-10">
            ...
            <div className="mt-10 text-center space-y-6">
              ...
              <div className="p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-[2rem] text-left">
